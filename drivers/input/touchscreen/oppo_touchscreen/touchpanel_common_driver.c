...
static void tp_gesture_handle(struct touchpanel_data *ts)
{
	...
	TPD_INFO("detect %s gesture\n",
		 ...
		 Circle ? "circle" : gesture_info_temp.gesture_type ==
		 ...
		 Wgestrue ? "(W)" : gesture_info_temp.gesture_type ==
		 FingerprintDown ? "(fingerprintdown)" : gesture_info_temp.
		 gesture_type == FingerprintUp ? "(fingerprintup)" : "unknown");
